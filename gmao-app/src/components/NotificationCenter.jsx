          ...
          {unreadCount > 0 && (
            <button
              ...
              style={{
                ...
                fontSize: '11px', fontWeight: '600', color: '#a7f3d0',
      ...
      <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
        {notifications.length === 0 ? (
          <div style={{
            ...
            justifyContent: 'center', padding: '48px 24px', color: '#94a3b8', gap: '10px',
          }}>
      ...
      {notifications.length > 0 && (
        <div style={{
          ...
          <span style={{ fontSize: '12px', color: '#94a3b8' }}>
            {unreadCount === 0 ? 'Toutes les notifications sont lues ✓' : `${unreadCount} non lue(s)`}
          </span>
        </div>
      )}
    </div>
